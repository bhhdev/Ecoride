 ...
 */
final class Version20260316162527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Trip (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, preference_id INT NOT NULL, vehicle_id INT NOT NULL, departureDay DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', departureHour TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\', arrivalDay DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', arrivalHour TIME NOT NULL COMMENT \'(DC2Type:time_immutable)\', departureAddress VARCHAR(50) NOT NULL, departureCity VARCHAR(50) NOT NULL, arrivalAddress VARCHAR(50) NOT NULL, arrivalCity VARCHAR(50) NOT NULL, seatPrice INT NOT NULL, numberSeats INT NOT NULL, seatAvailable INT NOT NULL, status VARCHAR(20) NOT NULL, createdAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updatedAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_D6645A05A76ED395 (user_id), UNIQUE INDEX UNIQ_D6645A05D81022C0 (preference_id), INDEX IDX_D6645A05545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE User (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, phone VARCHAR(10) NOT NULL, credits INT NOT NULL, isPassenger TINYINT(1) NOT NULL, isDriver TINYINT(1) NOT NULL, createdAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', avatar VARCHAR(255) DEFAULT NULL, isVerified TINYINT(1) DEFAULT 0 NOT NULL, UNIQUE INDEX UNIQ_2DA17977E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Vehicle (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, brand VARCHAR(50) NOT NULL, model VARCHAR(50) NOT NULL, numberSeats INT NOT NULL, energy VARCHAR(20) NOT NULL, color VARCHAR(30) NOT NULL, licenseNumber VARCHAR(20) NOT NULL, firstRegistrationDate DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', airConditionning TINYINT(1) NOT NULL, INDEX IDX_D43DDD1A7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
