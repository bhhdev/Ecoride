 ...
 */
final class Version20260306192658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Trip (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, preference_id INT NOT NULL, vehicle_id INT NOT NULL, departureDay DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', arrivalDay DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', departureAddress VARCHAR(50) NOT NULL, departureCity VARCHAR(50) NOT NULL, arrivalAddress VARCHAR(50) NOT NULL, arrivalCity VARCHAR(50) NOT NULL, seatPrice INT NOT NULL, numberSeats INT NOT NULL, seatAvailable INT NOT NULL, status VARCHAR(20) NOT NULL, createdAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updatedAt DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_D6645A05A76ED395 (user_id), UNIQUE INDEX UNIQ_D6645A05D81022C0 (preference_id), INDEX IDX_D6645A05545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
